...
public class ThemTK extends javax.swing.JFrame {
    ...
    public ThemTK(String id) throws IOException {
        this.id = id;
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(btn_suaMK, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 350, 70, -1));
        ...
        getContentPane().add(btn_troVe, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 80, -1));
            ...
            if (mkm.equals(mkxc)) {
                if (mkm.matches(pattern)) {
                    ...
                    try {
                        ...
                        throw new Exception("Thêm tài khoản thành công");
                    } catch (Exception ex) {
                ...
                throw new Exception("Mat khau khong trung nhau");
            }
        } catch (Exception e) {
